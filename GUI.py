...
resultLabel = Label(text="Image Manipulation Detection System", font=("Courier", 50))
...
# Button to run the CImage Manipulation detection algorithm
artifact = ttk.Button(text="Image Manipulation detection", style="my.TButton", command=cfa_artifact)
